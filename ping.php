...
function SendMail1($frommail,$tomail,$subject,$message,$fromfullname="Sindre Design")
{
    ...
    $smtp_host ='mail.kinhtanphuc.com';//Dia chi mail server
    $admin_email = 'info@kinhtanphuc.com';//User duoc khai bao tren mail server
    $smtp_username = 'info@kinhtanphuc.com';//User duoc khai bao tren mail server
