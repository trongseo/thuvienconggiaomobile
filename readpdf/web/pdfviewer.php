...
<!--#if !MINIFIED -->
    ...
    <script src="viewer.js"></script>
      ...
      //D:\project\github\tvcg\conggiaorepon\img\003002_Sach_Quan_Che_1.pdf
     //DEFAULT_URL='/img/003002_Sach_Quan_Che_1.pdf';
...
<!--                  <span data-l10n-id="download_label">Download</span>-->
<!--                </button>-->
                <a href="#" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView" title="Current view (copy or open in new window111)" tabindex="35" data-l10n-id="bookmark">
                  <span data-l10n-id="bookmark_label">Current View</span>
                </a>
<!--                  <a href="#" id="viewBookmarkList" class="toolbarButton bookmark hiddenSmallView" title="pen in new window111)" tabindex="35" data-l10n-id="bookmark">-->
<!--                      <span data-l10n-id="bookmark_label">Danh sach bookmark</span>-->
<!--                  </a>-->
