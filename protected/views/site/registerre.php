...
<form id="registration-form" method="post" class="form" onsubmit="return validateForm();"  action="/dang-ky">
<div class="row">
        ...
        <div class="box-login onlybox boxborder colorconggiao" style="">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-green pull-center btn-epub btnre" value="Đăng ký" id="btnsave" name="btnsave">
                        Đăng ký
                    </button>
                </div>
